  ...
  return (
    <Container>
      ...
      <Infos>
        ...
        <Intro>Site criado como projeto para a disciplina de Estágio Supervisionado II do curso de Sistemas de Informação da UNI7.
        </Intro>
      </Infos>
